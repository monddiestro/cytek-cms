...
<?php foreach ($products as $p): ?>
  <div id="drop-product-<?php echo $p->prod_id ?>" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-body">
          <h5>Are you sure to delete you want to delete <?php echo $p->prod_name; ?>?</h5>
        </div>
        <div class="modal-footer">
          <a href="<?php echo base_url('admin/drop_product?id='.$p->prod_id) ?>" class="btn btn-danger">Yes</a>
