...
DROP TABLE IF EXISTS `careers_tbl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `careers_tbl` WRITE;
/*!40000 ALTER TABLE `careers_tbl` DISABLE KEYS */;
INSERT INTO `careers_tbl` VALUES (1,'Web Developer','asdasdasdasdasda\'asda\'','2019-03-18 21:18:32');
/*!40000 ALTER TABLE `careers_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_tbl` VALUES (1,'Reymond','Diestro',1,'reymonddiestro@gmail.com','639176278173','d41d8cd98f00b204e9800998ecf8427e',NULL);
/*!40000 ALTER TABLE `user_tbl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `webstat_tbl`
--

DROP TABLE IF EXISTS `webstat_tbl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `webstat_tbl` (
...
--
-- Dumping data for table `webstat_tbl`
--

LOCK TABLES `webstat_tbl` WRITE;
/*!40000 ALTER TABLE `webstat_tbl` DISABLE KEYS */;
INSERT INTO `webstat_tbl` VALUES (1,'1');
/*!40000 ALTER TABLE `webstat_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-04-12 15:49:53
